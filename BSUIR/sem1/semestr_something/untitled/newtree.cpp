...
int nTree::balance(Node *n)
{
    return height(n->left)-height(n->right);
}
Node *nTree::rot_right(Node* smth)
{
...
void nTree::insert(Node* &n,int key)
{
    if(n==nullptr)
    {
        n=create(key);
...
std::string nTree::find(Node *n,int key)
{
...
std::vector <std::string> nTree::ret()
{
    return l;
}
